      ...
      <div class="row">
        ...
        <div class="col-md-12">
          <div class="box box-primary">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form role="form" method="post" action="{{route(produksi.update',$data->id_produksi)}}">
              {{ csrf_field() }}
              {{method_field('PUT')}}
         <div class="box-body">
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" name="nama_produksi" id="nama_produksi" placeholder="masukan data" value="{{$data->nama_produksi}}">
                </div>
