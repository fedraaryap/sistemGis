      ...
      <div class="row">
        ...
        <div class="col-md-12">
          <div class="box box-primary">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form role="form" method="post" action="{{route(SarprasPem.update',$data->id_sarpas_pemerintahan)}}">
              {{ csrf_field() }}
              {{method_field('PUT')}}
         <div class="box-body">
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" name="jenis_sarpras_pemerintahan" id="jenis_sarpras_pemerintahan" placeholder="masukan data" value="{{$data->jenis_sarpras_pemerintahan}}">
                </div>
