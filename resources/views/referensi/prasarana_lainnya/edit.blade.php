      ...
      <div class="row">
        ...
        <div class="col-md-12">
          <div class="box box-primary">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form role="form" method="post" action="{{route(praslainya.update',$data->id_prasarana_sarana)}}">
              {{ csrf_field() }}
              {{method_field('PUT')}}
          <div class="box-body">
                <div class="box-body">
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" name="macam_prasarana_sarana" id="macam_prasarana_sarana" placeholder="masukan data" value="{{$data->macam_prasarana_sarana}}">
                </div>
