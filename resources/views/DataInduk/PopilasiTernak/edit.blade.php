      ...
      <div class="row">
        ...
        <div class="col-md-12">
          <div class="box box-primary">
            ...
            <!-- /.box-header -->
            <!-- form start -->
          <form role="form" method="post" action="{{route('populasi.update',$data->id_populasi)}}">
              {{ csrf_field() }}
              {{method_field('PUT')}}
              <div class="box-body">
                <div class="form-group">
                  ...
                  <input type="number" class="form-control" name="jumlah_populasi" id="jumlah_populasi" placeholder="masukan data" value="{{$data->jumlah_populasi}}">
