      ...
      <div class="row">
        ...
        <div class="col-md-12">
          <div class="box box-primary">
            ...
            <!-- /.box-header -->
            <!-- form start -->
          <form role="form" method="post" action="{{route('jumstatsdm.update',$data->id_jumlah_kepadatan)}}">
              {{ csrf_field() }}
              {{method_field('PUT')}}
              <div class="box-body">
               ...
               <label for="id_status">Kepadatan</label>
                  ...
                  <input type="number" class="form-control" name="jumlah_sdm" id="jumlah_sdm" placeholder="masukan data" value="{{$data->jumlah_sdm}}">
