      ...
      <div class="row">
        ...
        <div class="col-md-12">
          <div class="box box-primary">
            ...
            <!-- /.box-header -->
            <!-- form start -->
          <form role="form" method="post" action="{{route('luaslahan.update',$data->id_luas_lahan)}}">
              {{ csrf_field() }}
              {{method_field('PUT')}}
              <div class="box-body">
               ...
               <label for="id_ket_lahan">Keterangan Lahan</label>
                  ...
                  <input type="text" class="form-control" name="pemilik_lahan" id="pemilik_lahan" placeholder="masukan data" value="{{$data->pemilik_lahan}}">
                  <label for="luas_lahan">Luas Lahan</label>
                  <input type="number" class="form-control" name="luas_lahan" id="luas_lahan" placeholder="masukan data" value="{{$data->luas_lahan}}">
