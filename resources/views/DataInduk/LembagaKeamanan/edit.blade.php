      ...
      <div class="row">
        ...
        <div class="col-md-12">
          <div class="box box-primary">
            ...
            <!-- /.box-header -->
            <!-- form start -->
          <form role="form" method="post" action="{{route('lemkeamanan.update',$data->id_keamanan)}}">
              {{ csrf_field() }}
              {{method_field('PUT')}}
              <div class="box-body">
               ...
               <label for="id_jenis_keamanan">Jenis Keamanan</label>
                  ...
                  <input type="number" class="form-control" name="jumlah_poskamling" id="jumlah_poskamling" placeholder="masukan data" value="{{$data->jumlah_poskamling}}">
                    <label for="jumlah_kegiaatan">Jumlah Kegiatan</label>
                  <input type="number" class="form-control" name="jumlah_kegiaatan" id="jumlah_kegiaatan" placeholder="masukan data" value="{{$data->jumlah_kegiaatan}}">
                    <label for="nama_organisasi_induk">Nama organisasi Induk</label>
                  <input type="text" class="form-control" name="nama_organisasi_induk" id="nama_organisasi_induk" placeholder="masukan data" value="{{$data->nama_organisasi_induk}}">
