...
<body>
    ...
    <div class="w3-bar w3-border w3-black">
      ...
      <a href="{{route('PetaDesa')}}" class="w3-bar-item w3-button w3-padding-16">Lembaga Pendidikan</a>
    </div>
</body>
</head>
    <body>
        ...
        <script>
            ...
            $.each(JSON.parse(desa),function desa(des_baru,i){
               // console.log(des_baru);
                ...
                console.log(nama);
                var geomi    = (i.geo);
                var jumpendidikan = (i.jumlah_anggota);
            ...
            function des(feature, layer) {
                layer.on({
                    ...
                    var popupContent = '<table> <id="table_wil" <tbody><tr><th scope="row">No:</th><td>'+ ([id] ) + '</td></tr><tr><th scope="row">Desa:</th><td>'+ ([nama]) + '</td></tr><tr><th scope="row">Jumlah anggota keamanan:</th><td>'+ ([jumpendidikan]) + '</td></tr><tr><th scope="row">Detail:</th><td><a  class="btnclick" href="/detailkeamanan/'+([nama])+ '"data_wil="'+ ([nama]) + '">Detail</a></td></tr></tbody></table>';
