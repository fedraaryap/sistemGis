...
?>
  ...
  <head>
        ...
        map.createPane('pane_INDONESIA_KABcopy_1');
        map.getPane('pane_INDONESIA_KABcopy_1').style.zIndex = 401;
        map.getPane('pane_INDONESIA_KABcopy_1').style['mix-blend-mode'] = 'normal';
        var layer_INDONESIA_KABcopy_1 = new L.geoJson(json_INDONESIA_KABcopy_1, {
            attribution: '<a href=""></a>',
            pane: 'pane_INDONESIA_KABcopy_1',
            onEachFeature: pop_INDONESIA_KABcopy_1,
            style: style_INDONESIA_KABcopy_1_0,
        });
        bounds_group.addLayer(layer_INDONESIA_KABcopy_1);
        map.addLayer(layer_INDONESIA_KABcopy_1);
        ...
        map.createPane('pane_Indo_Desa_region_2');
        map.getPane('pane_Indo_Desa_region_2').style.zIndex = 402;
        map.getPane('pane_Indo_Desa_region_2').style['mix-blend-mode'] = 'normal';
        var layer_Indo_Desa_region_2 = new L.geoJson(json_Indo_Desa_region_2, {
            attribution: '<a href=""></a>',
            pane: 'pane_Indo_Desa_region_2',
            onEachFeature: pop_Indo_Desa_region_2,
            style: style_Indo_Desa_region_2_0,
        });
        bounds_group.addLayer(layer_Indo_Desa_region_2);
        map.addLayer(layer_Indo_Desa_region_2);
        var baseMaps = {};
